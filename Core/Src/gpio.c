...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(I2C_SCK_GPIO_Port, I2C_SCK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : I2C_SCK_Pin */
  GPIO_InitStruct.Pin = I2C_SCK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_OD;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(I2C_SCK_GPIO_Port, &GPIO_InitStruct);
