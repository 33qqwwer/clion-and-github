...
//IO操作函数	 
#define FT_RST(n)   (n?HAL_GPIO_WritePin(CTP_RST_GPIO_Port,CTP_RST_Pin,GPIO_PIN_SET):HAL_GPIO_WritePin(CTP_RST_GPIO_Port,CTP_RST_Pin,GPIO_PIN_RESET))	//FT6336复位引脚
#define FT_INT    	HAL_GPIO_ReadPin(CTP_INT_GPIO_Port,CTP_INT_Pin) 		//FT6336中断引脚
